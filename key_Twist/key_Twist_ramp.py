...
def send_twist():
	global g_twist_pub, g_target_twist, g_last_twist_send_time, g_last_twist, g_vels_scales, g_vel_ramps
...
def fetch_param(name, default):	
	if rospy.has_param(name):
		...
		print "parameter [%s] not defined. Defaulting is %.3f" % (name, default)
	return default

if __name__ == '__main__':
	rospy.init_node('key_Twist_ramp')
